...
type EditProductNavigationProp = NativeStackNavigationProp<MainStackParamList>;
...
const EditProduct = () => {
  ...
  const loadProduct = async () => {
    try {
      ...
      if (product) {
        setFormData(product);
        setOriginalImage(product.image.toString());
      }
    } catch (error) {
  ...
  const resetImage = () => {
    setFormData({ ...formData, image: originalImage });
  };
          ...
          <View style={styles.form}>
            <View style={styles.photoSection}>
              <View style={styles.imageContainer}>
                {formData.image ? (
                  <Image 
                    source={{ uri: formData.image.toString() }} 
              ...
              <View style={styles.photoButtons}>
                ...
                {formData.image !== originalImage && (
                  <TouchableOpacity style={styles.photoButton} onPress={resetImage}>
                    <Icon name="restore" size={24} color="#000" />
                    <Text style={styles.photoButtonText}>Reset</Text>
                  </TouchableOpacity>
                )}
              </View>
            </View>
